...
public class CpfRgCnpj {
	
	private Logger logger = Logger.getLogger(CpfRgCnpj.class);
	
	public static void main(String[] args) {
		CpfRgCnpj gerador = new CpfRgCnpj();
	...
	public String cpf(boolean comPontos) {
		logger.info("Gerando o CPF com pontos: "+comPontos);
		int n = 9;
		int n1 = randomiza(n);
		int n2 = randomiza(n);
		int n3 = randomiza(n);
	...
	public String cnpj(boolean comPontos) {
		logger.info("Gerando o CNPJ com pontos: "+comPontos);
		int n = 9;
		int n1 = randomiza(n);
		int n2 = randomiza(n);
		int n3 = randomiza(n);
	...
	public String rg(boolean comPontos) {
		logger.info("Gerando o RG com pontos: "+comPontos);
